...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@ichigo.moe/ave/ai`, `@ichigo.moe/ave/agent`, `@ichigo.moe/ave`, `@ichigo.moe/ave/tui`, `typebox`.
