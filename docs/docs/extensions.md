...
| Package | Purpose |
|---------|---------|
| `@ichigo.moe/ave` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@ichigo.moe/ave/ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@ichigo.moe/ave/tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@ichigo.moe/ave";
...
```typescript
import { isBashToolResult } from "@ichigo.moe/ave";
...
```typescript
import { createLocalBashOperations } from "@ichigo.moe/ave";
...
```typescript
import { SessionManager } from "@ichigo.moe/ave";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@ichigo.moe/ave/ai";
...
```typescript
import type { AutocompleteItem } from "@ichigo.moe/ave/tui";
...
```typescript
import { withFileMutationQueue } from "@ichigo.moe/ave";
...
import { Type } from "typebox";
import { StringEnum } from "@ichigo.moe/ave/ai";
import { Text } from "@ichigo.moe/ave/tui";
...
**Important:** Use `StringEnum` from `@ichigo.moe/ave/ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@ichigo.moe/ave";
...
```typescript
import { createBashTool } from "@ichigo.moe/ave";
...
```typescript
import { keyHint } from "@ichigo.moe/ave";
...
```typescript
import { Text, Component } from "@ichigo.moe/ave/tui";
...
import { matchesKey } from "@ichigo.moe/ave/tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@ichigo.moe/ave";
