...
import { CLOUDFLARE_WORKERS_AI_BASE_URL } from "../src/ai/providers/cloudflare.js";
import {
	Api,
...
`;
	...
	// Write file
	writeFileSync(join(packageRoot, "src/ai/models.generated.ts"), output);
	console.log("Generated src/ai/models.generated.ts");
