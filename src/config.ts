...
export function getSelfUpdateUnavailableInstruction(packageName: string): string {
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/ichigo-Labs/ave/releases/latest`;
	}
...
export const PACKAGE_NAME: string = pkg.name || "@ichigo.moe/ave";
export const APP_NAME: string = piConfigName || "ave";
export const APP_TITLE: string = piConfigName ? APP_NAME : "ave";
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.AVE_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
