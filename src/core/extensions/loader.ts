...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@ichigo.moe/ave/agent": _bundledPiAgentCore,
	"@ichigo.moe/ave/tui": _bundledPiTui,
	"@ichigo.moe/ave/ai": _bundledPiAi,
	"@ichigo.moe/ave/ai/oauth": _bundledPiAiOauth,
	"@ichigo.moe/ave": _bundledPiCodingAgent,
};
...
function getAliases(): Record<string, string> {
	...
	_aliases = {
		"@ichigo.moe/ave": packageIndex,
		"@ichigo.moe/ave/agent": path.join(srcRoot, "agent/index.js"),
		"@ichigo.moe/ave/tui": path.join(srcRoot, "tui/index.js"),
		"@ichigo.moe/ave/ai": path.join(srcRoot, "ai/index.js"),
		"@ichigo.moe/ave/ai/oauth": path.join(srcRoot, "ai/oauth.js"),
