...
const MIGRATION_GUIDE_URL = "https://github.com/ichigo-Labs/ave/blob/main/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/ichigo-Labs/ave/blob/main/docs/docs/extensions.md";
