...
} from "../../src/ai/providers/openai-codex-responses.js";
import type { Context, Model } from "../../src/ai/types.js";

const originalFetch = global.fetch;
const originalAgentDir = process.env.AVE_CODING_AGENT_DIR;
...
afterEach(() => {
	...
	if (originalAgentDir === undefined) {
		...
		process.env.AVE_CODING_AGENT_DIR = originalAgentDir;
	}
	vi.restoreAllMocks();
});
...
describe("openai-codex streaming", () => {
	it("streams SSE responses into AssistantMessageEventStream", async () => {
		...
		process.env.AVE_CODING_AGENT_DIR = tempDir;
